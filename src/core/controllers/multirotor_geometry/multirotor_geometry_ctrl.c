...
void mr_geometry_ctrl_thrust_allocation(float *moment, float total_force)
{
	...
	float distributed_force = mat_data(u_c_star)[0] * 0.25; //split force to 4 motors
	float motor_force[4];
	motor_force[0] = -l_div_4 * mat_data(u_c_star)[1] + l_div_4 * mat_data(u_c_star)[2] +
	                 -b_div_4 * mat_data(u_c_star)[3] + distributed_force;
	motor_force[1] = +l_div_4 * mat_data(u_c_star)[1] + l_div_4 * mat_data(u_c_star)[2] +
	                 +b_div_4 * mat_data(u_c_star)[3] + distributed_force;
	motor_force[2] = +l_div_4 * mat_data(u_c_star)[1] - l_div_4 * mat_data(u_c_star)[2] +
	                 -b_div_4 * mat_data(u_c_star)[3] + distributed_force;
	motor_force[3] = -l_div_4 * mat_data(u_c_star)[1] - l_div_4 * mat_data(u_c_star)[2] +
	                 +b_div_4 * mat_data(u_c_star)[3] + distributed_force;
